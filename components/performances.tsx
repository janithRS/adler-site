  ...
  >
    <motion.div initial={{ opacity: 0, y: -5 }} animate={{ opacity: 1, y: 0 }}>
      <div className="container grid items-center justify-center gap-4 px-4 text-center md:px-6">
        <div className="space-y-3 px-8 md:px-0 lg:px-0">
          ...
          <p className="mx-auto max-w-[600px] text-gray-500 text-xs/relaxed md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed dark:text-gray-400">
            Here are some of the best performances by Adler.
          </p>
        </div>
        <div className="mx-auto w-full max-w-lg space-y-2 mt-10 flex flex-col items-center justify-center">
          <div className="grid grid-cols-1 gap-10 sm:gap-2 sm:grid-cols-3 lg:grid-cols-3 items-center lg:gap-20 md:gap-20">
            <div className="overflow-hidden flex items-center justify-center">
              <Image
                alt="Themagula Logo"
                className="fill-white opacity-100 lg:opacity-75 hover:opacity-100 hover:scale-95 hover:cursor-pointer"
                height={150}
            ...
            <div className="overflow-hidden flex items-center justify-center">
              <Image
                alt="IHW Logo"
                className="fill-current opacity-100 lg:opacity-75 hover:opacity-100 hover:scale-95 hover:cursor-pointer"
                height={150}
                src="/IHW-logo.svg"
                width={150}
              />
